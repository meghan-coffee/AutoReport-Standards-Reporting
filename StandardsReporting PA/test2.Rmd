...
colstoKeep <- c("Domain", "Core Idea", "PE", "CS", "AB", "PA Context", "PA Career Ready", "AFNR", "ISTE", "ELA", "NAAEE", "Math", "Social Studies", "ITEEA")
...
# Create table
ft <- flextable(processedWorkBook[['Earth and Space Sciences']])
```
